...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'category_delete' => array(array('id'), array('_controller' => 'App\\Controller\\AdminController::deleteCategory'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/delete')), array(), array()),
        ...
        'profile_show' => array(array('id'), array('_controller' => 'App\\Controller\\AdminController::show'), array(), array(array('variable', '/', '[^/]++', 'id')), array(), array()),
        'clinic_info_show' => array(array('id'), array('_controller' => 'App\\Controller\\ClinicController::show'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/admin/clinic')), array(), array()),
        ...
        'user_info_show' => array(array('id'), array('_controller' => 'App\\Controller\\UserInfoController::show'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/admin/user-management/admin/user-profile')), array(), array()),
